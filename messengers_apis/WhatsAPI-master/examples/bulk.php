 ...
 *
 * Usage:
 * $username = "380676188068";
  
  $password = "ADBWpJ7j91cyNLTyApY97UfNWLA=";
 
  $contacts = array("380999760371", "380442670389", "380503450189", "380976975569", "380638912045", "380612350208", "380993450178", "380447893407", "380953017834"); // or read them from a file
   
  $wbs = new WaBulkSender($username, $password);
  $wbs->Login();
  $wbs->SyncContacts($contacts);
  //$wbs->SendBulk($contacts, "bulk message");
  $wbs->SendBroadcast($contacts, "Broadcast message use 9 numbers");
 */
...
class WaBulkSender
{
    ...
    {
        $this->wa->sendSetProfilePicture($path);
    }
    /**
     * @param string[] $targets
     * @param $message
