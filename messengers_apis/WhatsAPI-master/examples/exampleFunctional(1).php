...
$nickname = "Secret";                          // This is the username (or nickname) displayed by WhatsApp clients.
...
echo "<br>Send_message-----------------------------------------------------------------------------------------<br>";
//$w->sendMessage($target, "Hey there! I am using WhatsApp.");
echo "<br>Lasr_seen-----------------------------------------------------------------------------------------<br>";
$w->sendGetRequestLastSeen($target);
echo "<br>Status-----------------------------------------------------------------------------------------<br>";
//$w->sendGetStatuses('380957506365');
echo "<br>-----------------------------------------------------------------------------------------<br>";
//echo $w->getAttribute('id');
//$w->sendMessageReceived('<receipt from="380999760371@s.whatsapp.net" id="message-1423499013-2" offline="0" t="1423499014"></receipt>', $type = null);
